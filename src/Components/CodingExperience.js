  ...
  render() {
    return (
      <div id="codingExperience">
        ...
        <WorkExperience Color={this.props.LandingColour} BackgroundColor={this.props.BackgroundColor}/>
        <h2 className={this.props.LandingColour}>web projects</h2>
        Use the left and right arrows to click through some of the web projects
        I've done!
        <br />
        <br />
        <WebSites />
