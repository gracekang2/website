    ...
    render() {
        return (
            <div id="aboutMe">
                ...
                <span className={this.props.BackgroundColour + " aboutMeCategory"}>Name:</span>
                <span className="aboutMeAns">Grace Kang 🤠</span>
                <br/>
                <br/>
                <span className={this.props.BackgroundColour + " aboutMeCategory"}>Program:</span>
                <span className="aboutMeAns">2B Computer Science, University of Waterloo 🦆</span>
                <br/>
                <br/>
                ...
                <p id="aboutMeDesc">
                    ...
                    and I'm a second year Computer Science student at the University of Waterloo. <br/>
                    When I'm not coding, I love to spend time with my loved ones (especially my dog), go hiking, and travel! 
                    Some of my favourite places that I've visited are Quebec City and 
                    California, but South Korea is definitely my top travel destination for all the delicious street food. 
                    I've always loved to take pictures everywhere I go, but I've recently taken up film photography. Even 
                    though it's expensive to keep up with the film + development costs, it's quickly become one of 
                    my favourite hobbies. 
                    <b><span className={this.props.LandingColour}> Scroll down to see some of my film pictures, and some other pictures I've taken in the last year or so! 
                    </span></b> You'll find lots of pictures of my friends, but also of my 
                    dog! His name is Teddy - my family adopted him in 2016, and I love him with all my heart.<br/>
                    Speaking in terms of my technical interests -- while most of my experience is in full-stack 
                    software engineering, I'm currently leaning more towards backend development! 
                    I would love any opportunity to grow in that area of Computer Science, so feel 
                    free to reach out if you're interested. For more information about my skillset or past 
                    technical experiences, you can head over to my skills summary or my coding experience section.<br/>
                    I am currently looking for an internship opportunity for <b><span className={this.props.LandingColour}> Fall 2020</span></b>, so I would love to chat!<br/>
                </p>
